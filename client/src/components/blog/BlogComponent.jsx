          ...
          {seacrhPost?.map((post, index) => (
            <div key={index} className="mx-auto">
              <div className="flex text-gray items-center gap-3">
               ...
               {
                post?.paid &&  <div className="felx  ">
                  <FaStar className="text-[#e6db49] inline-block  " size={20} />
                  <FaStar className="text-[#e6db49] inline-block  " size={15} />
                  <FaStar className="text-[#e6db49] inline-block " size={10} />
                </div>
               }
              </div>
